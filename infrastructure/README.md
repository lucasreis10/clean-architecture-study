...
You can then execute your native executable with: `./build/infrastructure-1.0-SNAPSHOT-runner`
...
- AWS Lambda Gateway REST API ([guide](https://quarkus.io/guides/amazon-lambda-http)): Build parent to bring in required
  dependencies
- Amazon
